...
//재고추가할때 
//메서드 내에서 입력을 받아도 되는가? --> 99.9%안함
//Scanner가 Drink안에 들어가면 음료가 입력을 받을 수 있는 능력이 생김
//따라서 메인에서 입력받고 음료는...음료가필요한 기능만 수고한다.
//유효성 검사 로직 코드는 모듈화를 해놓는 편 
