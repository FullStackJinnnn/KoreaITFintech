...
public class View4 {
	...
	public void adminInfo() {
		System.out.println("관리자 모드는 1234로 진입하실 수 있습니다.");
	}
	public void printMenu() { //로그아웃 상태일떼 뷰
	...
	public void printLoginMenu() { //로그아웃 상태일떼 뷰
	...
	public int inputAddCnt() {
		System.out.print("추가할재고량입력 >> ");
		int cnt = sc.nextInt();
		return cnt;
	}
	
	public int inputChangePrice() {
	...
	public void printSearchData(ProductDTO data) {
		System.out.println(data);
	}
