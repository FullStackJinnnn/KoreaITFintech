...
DELETE PROFESSOR WHERE PROFNO = 4008;
...
insert into professor
values(1002,'박승곤','sweety','정교수',380,to_date('1987-01-30','YYYY-MM-DD'),60,101,'sweety@abc.net','http://www.abc.net');
...
SELECT EMP_TYPE, PAY 월급
FROM EMP2
GROUP BY ROLLUP(EMP_TYPE, PAY);
...
INSERT INTO DEPT2 VALUES ('1021','영업1팀','1007','부산지사');
INSERT INTO DEPT2 VALUES ('1023','영업2팀','1007','경기지사');
INSERT INTO DEPT2 VALUES ('1022','영업3팀',+'1007','서울지사');
INSERT INTO DEPT2 VALUES ('1025','영업4팀','1007','울산지사');

SELECT COALESCE(POSITION, NAME) FROM EMP2;
SELECT CAST(DCODE AS NUMBER(06)) FROM DEPT2;
SELECT * FROM DEPT2 CONVERT (PDEPT, VARCHAR2, NUMBER(06)) ASC;
SELECT DCODE ||':'||  DNAME FROM DEPT2;
SELECT CONCAT(DCODE,'하세요',DNAME) FROM DEPT2;
SELECT * FROM DEPT2;
ALTER TABLE EMP2
...
ALTER TABLE EMP2 DROP CONSTRAINT FK_DEPTNO;
